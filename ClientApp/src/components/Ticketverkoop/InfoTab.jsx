...
export function InfoTab(props) {
    ...
    if (props.gekozenStoelen.length == 0) {
        ...
        return (
            <div className='square bg-dark rounded position-relative mx-auto w-25 p-3'>
                <div >
                    <img className='rounded shadow-4 float-sm-start' src={optreden.voorstelling.afbeelding} width='100%' />
